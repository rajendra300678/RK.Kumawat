...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/19nqhx3sa18N_hIVwZHtOqikHHCV10EAq/view", // Set to empty to hide the button
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Develop highly interactive Front end / User Interfaces for your Desktop and mobile applications"
    ),
    emoji(
      "⚡ Integration of third party services such as Firebase/ Payment Gateways / BitGo"
    )
  ],
...
const achievementSection = {
  ...
  achievementsCards: [
    ...
    },
    {
      ...
      title: "Navratrii Stickers",
      subtitle:
        "Elevate your messaging experience with our divine collection of Goddess Durga stickers. Celebrate the strength and grace of the Divine Mother with beautifully crafted stickers for all occasions. Share your devotion and blessings with friends and family.",
      image: require("./assets/images/Navratrii.webp"),
      imageAlt: "",
      footerLink: [
        {
          name: "View",
          url: "https://play.google.com/store/apps/details?id=com.ballapps.durgamatastickers&hl=en"
        }
      ]
    },
    {
